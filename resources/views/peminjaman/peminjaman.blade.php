            ...
            <div class="page-header d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="page-title mb-1">
                        <i class="bi bi-box-seam"></i> Manajemen Peminjaman
                    </h2>
                    <p class="text-muted mb-0">Kelola data peminjaman barang dengan mudah</p>
                </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <span class="fw-semibold">Daftar Peminjaman</span>
                    </div>
                    <button class="btn btn-light fw-semibold shadow-sm" data-bs-toggle="modal"
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="empty-state">
                                                ...
                                                <p class="text-muted mb-0">Silakan tambah peminjaman baru</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        <div class="modal fade" id="modalTambahPeminjaman" tabindex="-1" aria-labelledby="modalTambahPeminjamanLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="/peminjaman/submit" method="POST">
                        @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <label class="form-label">
                                        <i class="bi bi-box-seam me-2"></i>Pilih Barang
                                    </label>
                                        ...
                                        <div class="row mb-2 barang-row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" class="form-control jumlah-barang"
                                                    name="jumlah_pinjam[]" placeholder="Jumlah" min="1"
                                                    required>
                                            </div>
                                    ...
                                    <button type="button" class="btn btn-success btn-sm mt-2" id="addBarang">
                                ...
                                {{-- <div class="col-md-6">
                                    <label class="form-label">
                                        <i class="bi bi-person me-2"></i>Nama Peminjam
                                    </label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">
                                        <i class="bi bi-calendar-check me-2"></i>Batas Pengembalian
                                    </label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">
                                        <i class="bi bi-clipboard me-2"></i>Keperluan
                                    </label>
                                    <input type="text" class="form-control" name="keperluan"
                                        placeholder="Untuk keperluan..." required>
                                </div>
...
<div class="col-md-3">
    <input type="number" class="form-control jumlah-barang" name="jumlah_pinjam[]" placeholder="Jumlah"
        min="1" required>
</div>
<div class="col-md-3 d-grid">
    <button type="button" class="btn btn-danger btn-remove">
